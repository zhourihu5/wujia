...
public class CircleImageView extends AppCompatImageView {
    ...
    private static final int DEFAULT_TYPE = Color.TRANSPARENT;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mOverlayColor = a.getColor(R.styleable.CircleImageView_civ_overlay_color, DEFAULT_OVERLAY_COLOR);
        mType = a.getInt(R.styleable.CircleImageView_civ_type, TYPE_CIRCLE);
        mRoundRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_round_radius, DEFAULT_ROUND_RADIUS);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mType == TYPE_CIRCLE) {
            ...
            if (mOverlayColor != Color.TRANSPARENT){
                canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, mDrawableRadius, mOverlayPaint);
            }
            if (mBorderWidth != 0) {
    ...
    public void setOverlayColorResource(int overlayColorRes) {
        setOverlayColor(getContext().getResources().getColor(overlayColorRes));
    }
