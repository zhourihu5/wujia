 ...
 * description ：
 */
class WJPopWindow private constructor(private val mContext: Context) {
    var width: Int = 0
        private set
    var height: Int = 0
        private set
     ...
     * @return
     */
    fun showAsDropDown(anchor: View, xOff: Int, yOff: Int): WJPopWindow {
    ...
    fun showAsDropDown(anchor: View): WJPopWindow {
        if (mPopupWindow != null) {
    ...
    fun showAsDropDown(anchor: View, xOff: Int, yOff: Int, gravity: Int): WJPopWindow {
        if (mPopupWindow != null) {
     ...
     * @return
     */
    fun showAtLocation(parent: View, gravity: Int, x: Int, y: Int): WJPopWindow {
        if (mPopupWindow != null) {
    ...
    class PopupWindowBuilder(context: Context) {
        private val mWJPopWindow: WJPopWindow

        init {
            mWJPopWindow = WJPopWindow(context)
        }

        fun size(width: Int, height: Int): PopupWindowBuilder {
            mWJPopWindow.width = width
            mWJPopWindow.height = height
            return this
        }
