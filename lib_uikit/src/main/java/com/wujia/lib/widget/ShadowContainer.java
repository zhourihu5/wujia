...
//        int shadowColor = Color.RED;
        ...
        cornerRadius = a.getDimension(R.styleable.ShadowContainer_containerCornerRadius, context.getResources().getDimensionPixelSize(R.dimen.container_corner_radius));
        float dx = a.getDimension(R.styleable.ShadowContainer_deltaX, 0);
        float dy = a.getDimension(R.styleable.ShadowContainer_deltaY, context.getResources().getDimensionPixelSize(R.dimen.delta_y));
