package com.wujia.lib.widget.pickerview;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? context.getResources().getString(R.string.done) : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? context.getResources().getString(R.string.cancel) : Str_Cancel);
