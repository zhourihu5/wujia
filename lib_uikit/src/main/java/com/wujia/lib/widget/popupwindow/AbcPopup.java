package com.wujia.lib.widget.popupwindow;
 ...
 * @classdescribe popupwindow wraper class
 * @email:renxiaomin@100tal.com
 * @time 2018/6/2 上午11:09
 * @change
 * @changtime
 */
public class AbcPopup implements PopupWindow.OnDismissListener {
    private static final String TAG = "AbcPopup";
    ...
    public AbcPopup(Context context) {
        this.mContext = context;
    }

    public <T extends AbcPopup> T createPopup() {
    ...
    public <T extends AbcPopup> T setContentView(View contentView) {
        this.mContentView = contentView;
        this.mLayoutId = 0;
        return (T) this;
    }

    public <T extends AbcPopup> T setContentView(@LayoutRes int layoutId) {
        this.mContentView = null;
        this.mLayoutId = layoutId;
        return (T) this;
    }

    public <T extends AbcPopup> T setContentView(View contentView, int width, int height) {
        this.mContentView = contentView;
        this.mLayoutId = 0;
        this.mWidth = width;
        this.mHeight = height;
    ...
    public <T extends AbcPopup> T setContentView(@LayoutRes int layoutId, int width, int height) {
        this.mContentView = null;
        this.mLayoutId = layoutId;
        this.mWidth = width;
        this.mHeight = height;
    ...
    public <T extends AbcPopup> T setWidth(int width) {
        this.mWidth = width;
        return (T) this;
    }

    public <T extends AbcPopup> T setHeight(int height) {
        this.mHeight = height;
        return (T) this;
    }

    public <T extends AbcPopup> T setAnchorView(View view) {
        this.mAnchorView = view;
        return (T) this;
    }

    public <T extends AbcPopup> T setVerticalGravity(@VerticalGravity int verticalGravity) {
        this.mVerticalGravity = verticalGravity;
        return (T) this;
    }

    public <T extends AbcPopup> T setHorizontalGravity(@VerticalGravity int horizontalGravity) {
        this.mHorizontalGravity = horizontalGravity;
        return (T) this;
    }

    public <T extends AbcPopup> T setOffsetX(int offsetX) {
        this.mOffsetX = offsetX;
        return (T) this;
    }

    public <T extends AbcPopup> T setOffsetY(int offsetY) {
        this.mOffsetY = offsetY;
        return (T) this;
    }

    public <T extends AbcPopup> T setAnimationStyle(@StyleRes int animationStyle) {
        this.mAnimationStyle = animationStyle;
        return (T) this;
    }

    public <T extends AbcPopup> T setFocusable(boolean focusable) {
        this.mFocusable = focusable;
        return (T) this;
    }

    public <T extends AbcPopup> T setOutsideTouchable(boolean outsideTouchable) {
     ...
     * @return
     */
    public <T extends AbcPopup> T setFocusAndOutsideEnable(boolean focusAndOutsideEnable) {
     ...
     * 是否可以点击物理按键消失dimiss
     */
    public <T extends AbcPopup> T setKeyCodeBack(boolean keyCodeBack) {
        this.mKeyCodeBack = keyCodeBack;
        return (T) this;
    }
     ...
     * @return
     */
    public <T extends AbcPopup> T setBackgroundDimEnable(boolean isDim) {
        this.isBackgroundDim = isDim;
        return (T) this;
    }

    public <T extends AbcPopup> T setDimValue(@FloatRange(from = 0.0f, to = 1.0f) float dimValue) {
        this.mDimValue = dimValue;
        return (T) this;
    }

    public <T extends AbcPopup> T setDimColor(@ColorInt int color) {
        this.mDimColor = color;
        return (T) this;
    }

    public <T extends AbcPopup> T setDimView(@NonNull ViewGroup dimView) {
        this.mDimView = dimView;
        return (T) this;
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    public <T extends AbcPopup> T setEnterTransition(Transition enterTransition) {
        this.mEnterTransition = enterTransition;
        return (T) this;
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    public <T extends AbcPopup> T setExitTransition(Transition exitTransition) {
    ...
    private void removeViewFromParent() {
        if (mPopupWindow != null && mPopupWindow.getContentView() != null && mPopupWindow.getContentView().getParent() != null) {
            ViewGroup parent = (ViewGroup) mPopupWindow.getContentView().getParent();
            parent.removeView(mPopupWindow.getContentView());
        }
    }
     ...
     * @param listener
     */
    public <T extends AbcPopup> T setOnDismissListener(PopupWindow.OnDismissListener listener) {
