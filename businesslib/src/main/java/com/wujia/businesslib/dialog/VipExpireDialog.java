...
public class VipExpireDialog extends AbsDialog {
    ...
    protected Dialog createDialog(Context context, Object... params) {
        ...
        return new CommonDialog.Builder()
                .setDialogBg(com.wujia.lib.uikit.R.mipmap.dialog_background)
                .setWidth(0.6f)
                .setHeight(-1)
                .setContent(content)
    ...
    private SpannableString getSpan(final Context context, Object[] params) {
        ...
        if (showScan) {
            ...
            sp.setSpan(new ForegroundColorSpan(ContextCompat.getColor(context, com.wujia.lib.uikit.R.color.clr_fa6c51)), 25, 30, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        } else {
            sp = new SpannableString("伤心•••使用期已结束\n开通VIP，享受会员权益\n");
        }
        return sp;
