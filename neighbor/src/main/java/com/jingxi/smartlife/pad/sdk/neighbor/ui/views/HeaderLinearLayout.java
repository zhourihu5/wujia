...
public class HeaderLinearLayout extends LinearLayout {
    ...
    public HeaderLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HeaderLinearLayout);
        topOffset = a.getDimensionPixelSize(a.getIndex(R.styleable.HeaderLinearLayout_hvp_topOffset), topOffset);
        a.recycle();
