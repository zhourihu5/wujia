...
public class RoundImageView extends ImageView {
    private int mBorderThickness; // 厚度
    private int mBorderOutsideColor; // 外边框
    private int mBorderInsideColor; // 内边框
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderInsideColor = typedArray.getColor(R.styleable.RoundImageView_borderColor, getResources().getColor(R.color.color_split_line_ff5252));
        mBorderOutsideColor = typedArray.getInt(R.styleable.RoundImageView_borderOutsideColor, Color.TRANSPARENT);
        mBorderThickness = (int) typedArray.getDimension(R.styleable.RoundImageView_borderThickness, 0);
    }
