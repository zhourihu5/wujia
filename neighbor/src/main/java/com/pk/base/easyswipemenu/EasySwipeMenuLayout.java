package com.pk.base.easyswipemenu;
...
import static com.pk.base.easyswipemenu.State.CLOSE;
...
public class EasySwipeMenuLayout extends ViewGroup {
    ...
    public synchronized boolean dispatchTouchEvent(MotionEvent ev) {
        Log.e(TAG, "dispatchTouchEvent: " + this + " MotionEvent" + ev.getAction());
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                if (mViewCache != null && this != mViewCache) {
                    break;
                } else {
                    mViewCache = this;
                }
...
//                }
    ...
    private void handlerSwipeMenu(State result) {
        Log.e(TAG, "handlerSwipeMenu: " + result);
    ...
    public static void cleanmViewCache() {
        mViewCache = null;
        mStateCache = null;
    }
