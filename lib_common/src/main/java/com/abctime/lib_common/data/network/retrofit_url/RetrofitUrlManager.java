...
import com.abctime.lib_common.data.network.retrofit_url.parser.DefaultUrlParser;
import com.abctime.lib_common.data.network.retrofit_url.parser.UrlParser;
...
public class RetrofitUrlManager {
    ...
    private final ConcurrentHashMap<String, HttpUrl> mDomainNameHub = new ConcurrentHashMap<>();
