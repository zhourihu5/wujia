package com.abctime.lib_common.data;
...
public class SPHelper {
    ...
    public static final String IS_SHOW_GUIDE = "isShowGuide";//书架引导
    public static final String IS_SHOW_OPERATE_DIALOG = "isShowOperateDialog";//运营弹窗
    public static final String IS_SHOW_MAIN_V181 = "isShowMainV181";//是否首次进入app main
