...
public class ImageLoaderManager {
    ...
    public void loadRoundedCornersImages(String url, int placeholder, int roundRadius, ImageView imageView) {
        mStrategy.loadRoundedCornersImage(imageView.getContext(), url, placeholder, roundRadius, imageView);
    }

    public void loadRoundedCornersImages(String url, int placeholder, int errorHolder, int roundRadius, ImageView imageView) {
        mStrategy.loadRoundedCornersImage(imageView.getContext(), url, placeholder, errorHolder, roundRadius, imageView);
    }
