package com.abctime.lib.imageloader.transformation;
...
import com.abctime.lib.imageloader.ImageLoaderUtils;
...
public class GlideCircleTransform extends BitmapTransformation {
    ...
    public GlideCircleTransform(Context context, float borderWidth, int borderColor) {
        ...
        mBorderWidth = ImageLoaderUtils.dip2px(context, borderWidth);
    ...
    public GlideCircleTransform(Context context, float borderWidth, int borderColor, boolean isTop) {
        super(context);
        mBorderWidth = Resources.getSystem().getDisplayMetrics().density * borderWidth;
        mBorderWidth = ImageLoaderUtils.dip2px(context, borderWidth);
        mBorderPaint = new Paint();
